...
const config = {
  ...
  */
  ...
  // Keep the native/update asset set intentionally small. The previous project
  // had several old hero variants that were not referenced anywhere at runtime.
  assetBundlePatterns: [
    ...
    'assets/home/brand/hero-dusk.webp',
    'assets/home/brand/hero-dusk-light.webp',
    'assets/home/cities/*.png',
  ],
  ...
  plugins: [
    // Release size optimizations are applied via a local config plugin so they
    // survive every `expo prebuild`/EAS build.
